...
Equipe Taimin`;
    ...
    const prescriberInfo = `Profissão: ${customer.profissao || 'N/A'} | Reg. Profissional: ${customer.registro || 'N/A'}`;
    const whatsappMessage = `Olá! Meu nome é ${customer.name} (CPF: ${customer.cpf}, Tel: ${customer.phone || 'N/A'})\n${prescriberInfo}\n\nGostaria de fazer o seguinte pedido:\n\n${itemsText}\n\n*Total: ${formatCurrency(totalPriceValue)}*\n\n${closingMessage}`;
